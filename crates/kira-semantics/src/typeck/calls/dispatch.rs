//! Method calls and receiver writeback.
...
impl Analyzer<'_> {
    ...
    /// writeback.
    pub(super) fn callee_mutates(&self, call: HirExprId) -> bool {
        let HirExpr::Call {
    ...
    pub(super) fn add_writeback(&mut self, call: HirExprId, writeback: HirWriteback) {
