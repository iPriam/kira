...
2. [Kira for LLMs & Agents](/docs/for-llms) — a dense orientation if you are a model or coding agent
...
Operational material such as install flow, CLI commands, diagnostics, examples, platform targets, and shaders lives in the [Appendix](/docs/appendix).
