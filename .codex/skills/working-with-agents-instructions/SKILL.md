...
description: "Read before editing AGENTS.md, CLAUDE.md, or any .codex/skills/*/SKILL.md. Follow caveman:caveman and working-with-markdown first. Delete no-ops, state rules once, scope rules inline, use imperative voice, keep skills within 80 lines."
---
...
Keep `AGENTS.md` and `CLAUDE.md` for rules needed by nearly every task. Move situational rules into skills.
