---
title: Declarations
description: Import, annotation, capability, enum, function, class, struct, construct, and construct-form declarations in the current Kira language surface.
---
...
let end = ParseError.UnexpectedEnd
```

Inside `match`, patterns use unqualified variant names inferred from the matched enum.
